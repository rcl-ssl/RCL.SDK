...
The [RCL SDK](https://rcl-letsencrypt-auto-ssl.github.io/docs/sdk/sdk.html) provides a simple C# .NET Core 3.1 library to make authorized requests to the [RCL API](https://rcl-letsencrypt-auto-ssl.github.io/docs/api/api.html) . In this section, you will learn how to use the SDK.
...
```
Install-Package RCL.LetsEncrypt.SDK -Version 3.1.6
```
...
[Register an AAD Application](https://rclapp.com/authorization/aad_application)
...
[Set Access Control for the AAD application](https://rclapp.com/authorization/access_control)

### Register the AAD Application's ``Client Id`` in the RCL Lets Encrypt Portal

The AAD Application must be associated with a user's RCL Lets Encrypt subscription. This is achieved by registering the AAD Application's ``Client Id`` in the **RCL Lets Encrypt Portal**.

To add the AAD Application's ``Client Id`` to the portal, please follow the instructions in this link :

[Add the Client Id in the RCL Lets Encrypt Portal](https://rclapp.com/api/authorization#add-the-client-id-in-the-rcl-lets-encrypt-portal)
...
Make a GET request to the [Certificate API](https://rclapp.com/api/get-certificate.html)
...
Make a GET request to the [CertificateList API](https://rclapp.com/api/get-certificate-list)
...
Make a POST request to the [CertificateRenewal API](https://rclapp.com/api/post-certificate-renewal)
...
Make a POST request to the [Certificate API](https://rclapp.com/api/post-certificate)
...
The following productions apps were built with the RCL Lets Encrypt SDK :
